...
public class Dx4Profile implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7426090333625373330L;
	...
	public String validate(String vPassword,boolean exist,Dx4Role role)
	{
		String msg = "";
		if (exist == false)
			msg += checkEmail();

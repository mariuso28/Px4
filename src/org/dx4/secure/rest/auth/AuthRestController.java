package org.dx4.secure.rest.auth;
...
public class AuthRestController {
	...
	public Dx4ResultJson authorize(
		...
		String path;
		path = "http://localhost:8080/Dx4/Dx4/oauth/token";
		try {
	...
	public Dx4ResultJson refreshToken(
	...
	public Dx4ResultJson revokeRefreshToken(
			@RequestParam("refreshToken") String refreshToken
			){
		Dx4ResultJson result = new Dx4ResultJson();

...
public class Dx44DigitGameBig extends Dx44DigitGameSmall {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5110423761600451922L;
	@SuppressWarnings("unused")
	private static final Logger log = Logger.getLogger(Dx44DigitGameBig.class);
	
	public Dx44DigitGameBig()
	{

...
public class Dx4GameD2CC extends Dx4Game implements Serializable{

	private static final long serialVersionUID = -4034473439965544615L;

	public Dx4GameD2CC()
	{
		setGtype(Dx4GameTypeJson.D2CC);
	}

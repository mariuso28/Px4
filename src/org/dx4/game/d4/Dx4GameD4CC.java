...
public class Dx4GameD4CC extends Dx4Game {
	...
	private static final Logger log = Logger.getLogger(Dx4GameD4CC.class);
	
	public Dx4GameD4CC()
	{
		setGtype(Dx4GameTypeJson.D4CC);
	}
	...
	public List<Dx4Win> calcWin(Dx4MetaBet metaBet,Dx4Bet bet,Dx4DrawResultJson result)  {
		...
		if (result.getSecondPlace().equals(use))
		{
			...
			Dx4Win win = new Dx4Win(metaBet,bet,result.getFirstPlace(),Dx4PayOutTypeJson.Third.name(),

...
function submitForgotPassword()
    {
      ...
      if (!confirm('A reset password will be sent to your email account: ' + email))
        return false;
      window.location.replace("/4D/logon/password?user&email="+email);
      return false;
    }
...
<body>
  <div class="main">
    <form action="<c:url value="/logon/signin" />" method="POST">
          ...
          <div class="bg"></div>
    		...
    		<div class="heading">
              	...
              	<td><input id="emailDefault" class="inTable form-control" type="text"
    							name="email" value="co1@test.com" style="height:24px;"/></td>
    					</tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
